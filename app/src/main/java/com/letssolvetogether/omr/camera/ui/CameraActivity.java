...
public class CameraActivity extends AppCompatActivity implements
   ...
   private long examId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView examNameTextView = findViewById(R.id.exam_name_text_view);
        examNameTextView.setText("Exam Name: " + examName);
        if (mCameraView != null) {
        ...
        if (examName == null) {
            // Handle case where examName is not provided
    ...
    private void loadCorrectAnswers(){
        ...
        omrSheet = ViewModelProviders.of(this, new OMRSheetViewModelFactory(75, 0, 0)).get(OMRSheet.class);
    ...
    private CameraView.Callback mCallback
        ...
        public void onPreviewReady() {
            ...
            if(isBlurry || hasLowBrightness) {
                ...
                lowBrightnessImagesCount = 0;
                String examName = getIntent().getStringExtra("examName");
                ProcessOMRSheetAsyncTask processOMRSheetAsyncTask = new ProcessOMRSheetAsyncTask(mCameraView, omrSheet, examName, examId, dbHelper);
