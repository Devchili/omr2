...
public class Set2 extends AppCompatActivity implements RadioButton.OnCheckedChangeListener{

    private final int[] circleIds = new int[]{R.mipmap.ic_omr_circle_a, R.mipmap.ic_omr_circle_b, R.mipmap.ic_omr_circle_c, R.mipmap.ic_omr_circle_d, R.mipmap.ic_omr_circle_e};
    ...
    public void storeCorrectAnswers(int noOfQuestions){
        int[] correctAnswers = new int[noOfQuestions];
        int cnt = -1;
        CheckBox checkBox;
